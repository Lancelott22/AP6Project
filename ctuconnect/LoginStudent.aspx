<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="LoginStudent.aspx.cs" Inherits="ctuconnect.LoginStudent" %>
            ...
            <div class="container px-4 px-lg-5 h-100 box">
                ...
                <div class="row align-items-center justify-content-center text-center" >
                    <div class="col-lg-12 order-1 order-lg-2 topnav">
                              <a class="active" href="loginstudent">Student</a>
                              <a href="LoginIndustry.aspx">Industry</a>
                              <a href="LoginOJTCoordinator.aspx">Coordinator</a>
                    </div>
                </div>
                <br /><br />
                <div class="row gx-4 gx-lg-5 h-100 align-items-center justify-content-center text-center">
                    ...
                    <div class="col-lg-12 align-self-end">
                        <br /><br />
                        <a href="ForgotPassword_Student.aspx" class="link">Forgot password?</a>
                    </div> 
