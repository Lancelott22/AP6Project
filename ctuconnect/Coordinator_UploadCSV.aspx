     ...
     <asp:TableRow>
         ...
         <asp:TableCell Style="padding:0px 5px 0px 40px">
            <div class="display-container">
                ...
                <div>
                    <h3>Upload CSV for Intern</h3>
                    <asp:FileUpload ID="studentCSV" runat="server" />
                    <asp:Button Text="Upload Intern CSV" ID="UploadInternCSV" OnClick="UploadInternCSV_Click" runat="server" />
                </div>
                <div>
                    <h3>Upload CSV for Graduates</h3>
                    <asp:FileUpload ID="graduateCSV" runat="server" />
                    <asp:Button Text="Upload Graduate CSV" ID="UploadGraduate" OnClick="UploadGraduate_Click" runat="server" />
                </div>
            </div>
         </asp:TableCell>
     </asp:TableRow>
