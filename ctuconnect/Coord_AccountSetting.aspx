         ...
         <asp:TableCell  style="vertical-align: top;">
              <div class="profile-container">
                   <asp:Image ID="CoordinatorImage" runat="server"/>   
                       ...
                       <a class="active" href="Coord_AccountSetting.aspx"><i class="fa fa-cog" aria-hidden="true" style="padding-right:12px;"></i>Account Settings</a>
            ...
            <div class="display-container">
               ...
               <asp:TextBox ID="Oldpass" runat="server" TextMode="Password" CssClass ="form-control" width ="250px" placeholder="Enter old password"></asp:TextBox>
                <asp:Label ID="PasswordErrorMessage" Font-Size="15px" runat="server" Text="Invalid password! Please enter your current password!" CssClass="text-danger"></asp:Label>             
                    <asp:RequiredFieldValidator ID="reqOldpass" Font-Size="15px" runat="server" ErrorMessage="Required Field!" ControlToValidate="Oldpass" Display="Dynamic" CssClass="text-danger" ValidationGroup="UpdatePass"></asp:RequiredFieldValidator>  
      </div>
    <div class="form-group">         
                    ...
                    <asp:RequiredFieldValidator ID="reqnewpassword" Font-Size="15px" runat="server" ErrorMessage="Required Field!" ControlToValidate="Newpass" Display="Dynamic" CssClass="text-danger" ValidationGroup="UpdatePass"></asp:RequiredFieldValidator>                                                                                                          <!-- "^(?=.*\d)(?=.*[A-Z])(?=.*\W)(?!.*\s).{8,}$"-->
     ...
     <div class="form-group">         
               ...
               <asp:RequiredFieldValidator ID="reqConfirmNewPass" Font-Size="15px" runat="server" ErrorMessage="Required Field!" ControlToValidate="confirmNewPass" Display="Dynamic" CssClass="text-danger" ValidationGroup="UpdatePass"></asp:RequiredFieldValidator>
      ...
      <div class="form-group">
        <div style="margin-left: 10px">
             <asp:Button ID="BtnUpdatePass" class ="btn btn-success" runat="server" Text="Update Password" OnClick="BtnUpdatePass_Click" ValidationGroup="UpdatePass" />   
