<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ForgotPassword_Student.aspx.cs" Inherits="ctuconnect.ForgotPassword_Student" %>
        ...
        <div class="container box">
            ...
            <div class="row">
                <div class="col-12" style="font-size:20px; padding-left:1em;">
                    ...
                    <asp:TextBox ID="txtstudentID" CssClass="txtbox" runat="server" Height="40px" AutoPostBack="true" OnTextChanged="txtstudentID_TextChanged"></asp:TextBox><br />
