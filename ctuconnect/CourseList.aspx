<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="CourseList.aspx.cs" Inherits="UserInterface.CourseList" %>
               ...
               <div class="display-container">
                   ...
                   <asp:GridView ID="GridView1" runat="server" Style="color:black; " AutoGenerateColumns="false"  ShowHeaderWhenEmpty="true" CssClass="gridview-style"
                        ...
                        <HeaderStyle Font-Bold="false" BackColor="#D3D3D3" Font-Size="12px" ForeColor="black" Height="28px"  HorizontalAlign="Center" VerticalAlign="Middle" Width="100%" />
                            ...
                            <Columns >
                               <asp:BoundField DataField="No." HeaderText=""  ItemStyle-BorderColor="#c1beba" ItemStyle-BorderStyle="Solid" ItemStyle-BorderWidth="1px"/>
                                ...
                                <asp:BoundField DataField="CourseName" HeaderText="Name" ItemStyle-BorderColor="#c1beba" ItemStyle-BorderStyle="Solid" ItemStyle-BorderWidth="1px" />
                                ...
                                <asp:BoundField DataField="hours" HeaderText="Internship hours" ItemStyle-BorderColor="#c1beba" ItemStyle-BorderStyle="Solid" ItemStyle-BorderWidth="1px" />
