        ...
        <div class="col-3 d-flex flex-column" >
            <div class="nav flex-column flex-nowrap vh-100 overflow-auto p-2">
                <div class="profile-container">
                    ...
                    <a class="active" href="ListOfInterns_Alumni.aspx">
                        <i class="fa fa-industry" aria-hidden="true" style="padding-right:7px; width:32px;"></i>
                        List of Interns
                    </a>
                                ...
                                <HeaderTemplate> 
                                    <table  class="table-list">
                                        <tr>
                                            ...
                                            <th style="width: 220px;">Middle initial</th>
                                            <th style="width: 220px;">Program enrolled</th>
                                        ...
                                        <ItemTemplate>
                                            <table class="table-list">
                                            <tr class="datas">
                                                 <td style="width: 140px;"><%# Eval("studentId") %></td>
                                                <td style="width: 210px;"><%# Eval("lastname") %></td>
                                                <td style="width: 228px;"><%# Eval("firstname") %></td>
                                                <td style="width: 200px;"><%# Eval("midinitials") %></td>
                                                <td style="width: 190px;"><%# Eval("course") %></td>
                                                <td style="width: 190px;"><%# Eval("contactNumber") %></td>
                                                <td><%# Eval("email") %></td>
                                            </tr>
                                                </table>
                                        </ItemTemplate>
