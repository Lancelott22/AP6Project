<%@ Page Title="" Language="C#" MasterPageFile="~/Industry.Master" AutoEventWireup="true" CodeBehind="ViewEvaluation1.aspx.cs" Inherits="ctuconnect.ViewEvaluation" EnableEventValidation="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="button1">
        <div class="row">
            ...
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <div class="col-2 d-flex flex-column">
                <asp:Button ID="btnClose" runat="server" Text="Close" OnClick="btnClose_Click" class="btn btn-primary btn-md btn-close" />
            </div>
        </div>
    </div>
</asp:Content>
